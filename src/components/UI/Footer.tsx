  ...
  <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
      <div className="grid grid-cols-2 gap-8">
          <div className='text-center'>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{t('footer.association')}</h2>
              <ul className="text-gray-500 dark:text-gray-400">
                  <li className="mb-4">
                      <Link to="/about" className=" hover:underline">{t('footer.about')}</Link>
                  </li>
                  <li className="mb-4">
                      <Link to="/posts" className="hover:underline">{t('footer.blog')}</Link>
                  </li>
              </ul>
          </div>
          <div className='text-center'>
              ...
              <ul className="text-gray-500 dark:text-gray-400">
                  <li className="mb-4">
                      <a href="https://www.facebook.com/creceenlibertad" className="hover:underline">Facebook</a>
                  </li>
                  <li className="mb-4">
                      <a href="/contact" className="hover:underline">{t('footer.contact-page')}</a>
                  </li>
              </ul>
          </div>
      </div>
      <div className="text-center">
          ...
          <ul className="flex justify-center mt-5 space-x-5">
              <li>
                  <a href='https://www.facebook.com/creceenlibertad' className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
              ...
              <li>
                  <a href="https://www.instagram.com/creceenlibertad/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
