type TeamUserCardType = {
  name: string;
  occupation: string;
  email: string;
  variantImage?: 1 | 2 | 3 | 4
}
    ...
    <div >
                <div  className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" >
                    ...
                    <div  className="relative overflow-hidden px-6">
                        <img src={`https://tailone.tailwindtemplate.net/src/img/dummy/avatar${variantImage}.png`}  className="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale" alt="title image"/>
                    </div>
                    <div  className="pt-6 text-center">
                        <p  className="text-lg leading-normal font-bold mb-1">{name}</p>
                        <p  className="text-gray-500 leading-relaxed font-light">{occupation}</p>
                        <p  className="text-gray-500 leading-relaxed font-light">{email}</p>
                        <div  className="mt-2 mb-5 space-x-2">
                            <a  className="hover:text-primary-700" aria-label="Twitter link" href="#">
                            ...
                            <a  className="hover:text-primary-700" aria-label="Facebook link" href="#">
                            ...
                            <a  className="hover:text-primary-700" aria-label="Instagram link" href="#">
                            ...
                            <a  className="hover:text-primary-700" aria-label="Linkedin link" href="#">
