                ...
                <div  className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" >
                    ...
                    <div  className="pt-6 text-center">
                        ...
                        <div  className="mt-2 mb-5 space-x-2">
                            <a  className="hover:text-yellow-700" aria-label="Twitter link" href="#">
                            ...
                            <a  className="hover:text-yellow-700" aria-label="Facebook link" href="#">
                            ...
                            <a  className="hover:text-yellow-700" aria-label="Instagram link" href="#">
                            ...
                            <a  className="hover:text-yellow-700" aria-label="Linkedin link" href="#">
